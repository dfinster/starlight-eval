---
title: Starlight Eval
head:
  - tag: title
    content: Starlight Eval
description: Just testing Starlight
template: splash
editUrl: false
lastUpdated: false
# banner:
...
#     </a>
hero:
  title: Just testing Starlight
  tagline: It's just an evaluation of Starlight.
  image:
  ...
  actions:
    ...
    - text: View on GitHub
      icon: external
      variant: minimal
      link: https://github.com/dfinster/starlight-eval
---
