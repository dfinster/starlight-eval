...
:::note
For a complete list of available icons, please refer to the [Starlight Icons documentation](https://starlight.astro.build/reference/icons/) on the official site.
:::
